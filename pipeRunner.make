...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/pipeRunner
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/pipeRunner
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/pipeRunner
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/pipeRunner
  DEFINES   +=
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/pipeRunner
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/pipeRunner
  DEFINES   += -DDEBUG
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/pipeRunner
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/pipeRunner
  DEFINES   +=
  INCLUDES  += -I. -Isrc/gKit
...
$(OBJDIR)/wavefront.o: src/gKit/wavefront.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/obstacle.o: src/pipeRunner/obstacle.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/pipe.o: src/pipeRunner/pipe.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/pipeRunner.o: src/pipeRunner/pipeRunner.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
